    ...
    if (interaction.type === InteractionType.MessageComponent) {
        ...
        if (interaction.customId === 'get_token') {
            ...
            if (singleTokenLimit === 0) {
                return interaction.reply({ content: 'Token Eklemek İçin Heran Gibi Bir Üyeliğiniz Bulunmuyor', ephemeral: true });
            }
...
client.on('messageCreate', async message => {
    if (message.content.startsWith('!pm2')) { 
        ...
        const allowedIds = ["817463869487185980"]; 
