...
module.exports = {
    ...
    async onRequest(client, message, args) {
        const allowedGuildId = '1283906213951836184'; //Sunucu ıd baro kardesim
        const allowedRoleIds = ['1284053958595448842', '1284053960205926421', '1286718642805018635', '1287702750544531490']; //komutu kullancak roller
        ...
        const roles = [
            { label: 'Aura +MVIP Paket', value: '1287365392788095017', level: 5 },
